...
apt-get -y install php-pear php-curl php7.1-fpm php7.1-mcrypt php7.1-curl php7.1-cli php7.1-mysql php7.1-gd php7.1-intl php7.1-xsl php7.1-gd php-ssh2 php7.1-mbstring php7.1-soap php7.1-zip libgeoip-dev libgd-dev libssh2-1 libzip4 libperl-dev libpcre3 libpcre3-dev libssl-dev zlib1g-dev nginx
